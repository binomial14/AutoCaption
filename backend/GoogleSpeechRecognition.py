...
async def google_speech_recognition(client, web_config):
    ...
    config = speech.RecognitionConfig(
        ...
        model=web_config["model"], # check https://cloud.google.com/speech-to-text/docs/transcription-model for different types of model, medical_conversation, latest_long
